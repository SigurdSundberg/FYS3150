...
%  https://raw.githubusercontent.com/gregwinther/FYS3150-ComputationalPhysics/master/Project1/article/article.tex
\usepackage[]{graphicx}
\usepackage[]{hyperref}
\usepackage[]{physics}
\usepackage[]{listings}
...
\normalsize{Tridiagonal Matrix Algorithm and LU-decomposition} \\
...
\subsubsection{Specialized algorithm}
